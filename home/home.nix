  ...
  wallpapers = [
    {
      ...
      audio = {
        ...
        automute = true;   # Prevents pipewire sync dropping (--noautomute), if you want to keep audio reactive features make it sure that have the wireplumber.extraConfig:
