...
extraArgs = [
        ...
        # --- 4. SOCKET WHITELIST ---
        # Use whitelist to bypass Chromium's strict /run directory isolation.
        # \${RUNUSER} tells Nix to pass the literal string "${RUNUSER}" to Firejail,
        # which Firejail automatically maps to /run/user/1000.
